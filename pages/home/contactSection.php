            ...
            <div class="max-w-2xl mx-auto">
                <div class="bg-white p-8 rounded-lg shadow-md">
                    <div class="text-center">
                        ...
                        <!-- Icône principale -->
                        <div class="w-16 h-16 bg-bleu rounded-full flex items-center justify-center mx-auto mb-6">
                        ...
                        <!-- Contenu informatif -->
                        <h3 class="font-bebas text-3xl text-noir tracking-wide mb-4">
                            CONTACTEZ-NOUS
                        </h3>
                        ...
                        <!-- Bouton principal -->
                        <a href="<?php echo $base_url; ?>/pages/contact.php" class="inline-block bg-bleu text-white font-bebas text-xl px-8 py-4 rounded-lg tracking-wide hover:bg-bleu/90 transition-colors duration-300">
                            NOUS CONTACTER
                        </a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const contactSection = document.querySelector('section:has(.bg-bleu)');
    if (contactSection) {
