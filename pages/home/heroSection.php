    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <div class="hero-buttons flex flex-wrap gap-3 opacity-0 translate-y-8 transition-all duration-1000 delay-600">
                <a href="../login.php" class="inline-flex items-center justify-center px-6 py-3 font-anek font-medium text-center text-white rounded-lg bg-rouge hover:bg-rouge/90 focus:ring-4 focus:ring-rouge/30 transition-all duration-200 hover:scale-105">
                    Se connecter
